...
for idx = 1:87
    ...
    u_k_base = u_k_base_delay + 0.413*e_k_base - 0.2008*e_k_base_delay;
    u_k_shoulder = u_k_shoulder_delay + 0.1572*e_k_shoulder + 0.06513*e_k_shoulder_delay;
    u_k_forearm = u_k_forearm_delay + 0.413*e_k_forearm - 0.2008*e_k_forearm_delay;
